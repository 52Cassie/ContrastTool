...
void CContrastToolDlg::OnBnClickedNewdataButton()
{
	...
	CFileDialog fileDlg(true, _T("xls;xlsx"), _T("*.xls;*.xlsx"), OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT, _T("xlsx Files (*.xls;*.xlsx)|*.xls;*.xlsx|xlsx Files (*.xlsx)|*.xlsx|xls Files (*.xls)|*.xls|All Files (*.*)|*.*||"), NULL);
